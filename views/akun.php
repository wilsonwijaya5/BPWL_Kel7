...
<head>
    <title>Akun | Karawaci Furniture</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="p-4 p-md-5">
            ...
            <h2>Data Akun</h2>
            <a href="akun_input.php">Input Data</a>
            <table border="1">
            <div class="container">
			...
			<div class="row">
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $x['akses']; ?></td>
                        <td>
                            <a href="akun_edit.php?username=<?php echo $x['username']; ?>&aksi=edit_user">Edit |</a>
                            <a href="../controllers/proses.php?username=<?php echo $x['username']; ?>&aksi=delete_user">Hapus</a>
                        </td>
                    </tr>
                <?php
                }
