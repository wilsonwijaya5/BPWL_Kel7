...
<body>
    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="p-4 p-md-5">
            ...
            <a href="pembelian_input.php">Input Data</a>
            <table border="1">
                <tr>
                    <th> No </th>
                    <th> Kode Beli </th>
                ...
                <?php
                $no = 1;
                foreach ($db->tampil_data_pembelian() as $x) {
                ?>
                    <tr>
                        <td><?php echo $no++; ?></td>
                        ...
                        <td>
                            <a href="pembelian_edit.php?kode_beli=<?php echo $x['kode_beli']; ?>&aksi=edit_pembelian">Edit |</a>
                            <a href="../controllers/proses.php?kode_beli=<?php echo $x['kode_beli']; ?>&aksi=delete_pembelian">Hapus</a>
                        </td>
                    </tr>
                <?php
                }
