...
<head>
    <title>Contact | Karawaci Furniture</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="wrapper d-flex align-items-stretch">
        <nav id="sidebar" class="active">
            <h1><a href="userpage.php" class="logo">KW</a></h1>
        ...
        <div id="content" class="p-4 p-md-5">
            ...
            <section class="contact">
                <div class="container">
                    <center><h3>Kontak Info</h3></center>
                    
                    <div class="box">
                        <div class="col-4">
                            <h4>Email</h4>
                            <p>Karawaci_Furniture@gmail.com</p>
                    </div>
                    <div class="box">
                        <div class="col-4">
                            <h4>WhatsApp </h4>
                    ...
                    <div class="box">
                        <div class="col-4">
                            <h4>Social Media</h4>
                            <p>@Karawaci_Furniture</p>
                    </div>
                    <div class="box">
                            <center><h4>Alamat</h4></center>
                    </div>
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d173.3773720731981!2d101.4389188628467!3d0.5601969817658897!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x3aac911ebd903d83!2sCentral%20Furniture!5e1!3m2!1sen!2sid!4v1627808740025!5m2!1sen!2sid" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
