...
<body>
    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="p-4 p-md-5">
            ...
            <h2 class="mb-3">Kontak Karawaci Furniture</h2>
            <h4>Selamat Datang di Karawaci Furniture</h4>
            <p>Karawaci Furniture merupakan tempat yang menjual berbagai furniture dengan harga terjangkau, disini kami menyediakan barang-barang furniture seperti, lemari, meja, kursi, sofa, c ermin, rak buku, dan masih banyak lagi. Silahkan cek halaman Furniture untuk dapat melihat berbagai furniture yang kami sediakan.</p>
        </div>
    </div>
