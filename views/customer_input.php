			...
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-md-6 text-center mb-5">
						<h2 class="heading-section">Masukan Data Customer</h2>
					</div>
				</div>
				<div class="row justify-content-center">
					<div class="col-md-16">
							...
							<div class="row no-gutters">
								<div class="col-lg-6">
									<div class="contact-wrap w-100 p-md-5 p-4">
										...
										<form action="../controllers/proses.php?aksi=tambah_customer" method="POST" id="contactForm" name="contactForm" class="contactForm">
											<div class="row">
												<div class="col-md-12">
													<div class="form-group">
														<input type="text" class="form-control" name="kode_customer" id="kode_customer" placeholder="Kode Customer" />
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
												...
												<div class="col-md-12">
													<div class="form-group">
														<input type="text" class="form-control" name="kota_customer" id="kota_customer" placeholder="Kota Customer" />
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
														<input type="text" class="form-control" name="alamat_customer" id="alamat_customer" placeholder="Alamat Customer" />
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
														<input type="text" class="form-control" name="telp_customer" id="telp_customer" placeholder="Telp Customer" />
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
								...
								<div class="col-lg-6 d-flex align-items-stretch">
									<div class="info-wrap w-100 p-5 img" style="background-image: url(../assets/pembelian_edit/images/img4.jpg);">
									</div>
								</div>
							</div>
						</div>
