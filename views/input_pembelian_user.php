                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="furniture_user.php">Furniture</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="pembelian_user.php">Beli</a>
                            </li>
                            <li class="nav-item">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-6 text-center mb-5">
                        <h2 class="heading-section">Penginputan Data Pembelian</h2>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-md-16">
                            ...
                            <div class="row no-gutters">
                                <div class="col-lg-6">
                                    <div class="contact-wrap w-100 p-md-5 p-4">
                                        ...
                                        <form action="../controllers/proses.php?aksi=tambah_pembelian_user" method="POST" id="contactForm" name="contactForm" class="contactForm">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" name="kode_beli" id="kode_beli" placeholder="Kode Beli" />
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" value="<?php echo $_SESSION['key']; ?>" name="kode_customer" id="kode_customer" placeholder="Kode Customer" />
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" name="tgl_beli" id="tgl_beli" placeholder="Tanggal Beli" />
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" name="jml_beli" id="jml_beli" placeholder="Jumlah Beli" />
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
