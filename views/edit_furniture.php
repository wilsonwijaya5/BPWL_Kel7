		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Edit Data Furniture</h2>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-md-16">
						...
						<div class="row no-gutters">
							<div class="col-lg-6">
				      		...
				      		<div id="form-message-success" class="mb-4">
									...
									<form action="../controllers/proses.php?aksi=update_furniture" method="POST" id="contactForm" name="contactForm" class="contactForm">
									<?php 
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													<input type="text" class="form-control" name="kode_furniture" value="<?php echo $x['kode_furniture'] ?>">
												</div>
											</div>
											<div class="col-md-12"> 
												<div class="form-group">
													<input type="text" class="form-control" name="nama_furniture" value="<?php echo $x['nama_furniture'] ?>">
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
													<input type="text" class="form-control" name="jenis_furniture" value="<?php echo $x['jenis_furniture'] ?>">
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
													<input type="text" class="form-control" name="bahan_furniture" value="<?php echo $x['bahan_furniture'] ?>">
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
													<input type="text" class="form-control" name="stok_furniture" value="<?php echo $x['stok_furniture'] ?>">
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
													<input type="text" class="form-control" name="harga_furniture" value="<?php echo $x['harga_furniture'] ?>">
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
							...
							<div class="col-lg-6 d-flex align-items-stretch">
								<div class="info-wrap w-100 p-5 img" style="background-image: url(../assets/pembelian_edit/images/img11.jpg);">
			          		</div>
							</div>
						</div>
					</div>
