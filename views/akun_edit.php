            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-6 text-center mb-5">
                        <h2 class="heading-section">Edit Data Akun</h2>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-md-16">
                            ...
                            <div class="row no-gutters">
                                <div class="col-lg-6">
                                    <div class="contact-wrap w-100 p-md-5 p-4">
                                        ...
                                        <form action="../controllers/proses.php?aksi=update_user" method="POST" id="contactForm" name="contactForm" class="contactForm">
                                            <?php
                                            foreach ($db->edit_user($_GET['username']) as $x) {
                                            ?>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" name="password" value="<?php echo $x['password'] ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" name="akses" value="<?php echo $x['akses'] ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                ...
                                <div class="col-lg-6 d-flex align-items-stretch">
                                    <div class="info-wrap w-100 p-5 img" style="background-image: url(../assets/pembelian_edit/images/img6.jpg);">
                                    </div>
                                </div>
                            </div>
                        </div>
