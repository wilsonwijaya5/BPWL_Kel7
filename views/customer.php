...
<head>
    <title>Customer | Karawaci Furniture</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="p-4 p-md-5">
            ...
            <h2>Data Customer</h2>
            <a href="customer_input.php">Input Data</a>
            <table border="1">
                <tr>
                    <th> No </th>
                    <th> Kode Customer </th>
                ...
                <?php
                $no = 1;
                foreach ($db->tampil_data_customer() as $x) {
                ?>
                    <tr>
                        <td><?php echo $no++; ?></td>
                        <td><?php echo $x['kode_customer']; ?></td>
                        <td><?php echo $x['nama_customer']; ?></td>
                        <td><?php echo $x['kota_customer']; ?></td>
                        <td><?php echo $x['alamat_customer']; ?></td>
                        <td><?php echo $x['telp_customer']; ?></td>
                        <td>
                            <a href="customer_edit.php?kode_customer=<?php echo $x['kode_customer']; ?>&aksi=edit_customer">Edit |</a>
                            <a href="../controllers/proses.php?kode_customer=<?php echo $x['kode_customer']; ?>&aksi=delete_customer">Hapus</a>
                        </td>
                    </tr>
                <?php
                }
